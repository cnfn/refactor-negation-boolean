...
public class CommonNegationBooleanActionTest extends LightJavaCodeInsightFixtureTestCase {
    ...
    protected String getTestDataPath() {
        return "src/test/testData/com.github.cnfn.action.CommonNegationBooleanAction";
    }
